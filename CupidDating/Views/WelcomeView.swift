...
struct WelcomeView: View {
    var body: some View {
        GeometryReader{ geometry in
            ZStack {
                LinearGradient(gradient: Gradient(colors: [Color(red: 247/255, green: 98/255, blue: 89/255), Color(red: 245/255, green: 39/255, blue: 119/255)]), startPoint: .topTrailing, endPoint: .bottomLeading)
